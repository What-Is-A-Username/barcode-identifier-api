...
echo "Setting up /vol/static/ folders to store static and media"
mkdir -p /vol/static/static
chmod -R 765 /vol/static/static
chown -R appuser:appgroup /vol/static/static
mkdir -p /vol/static/media
chmod -R 765 /vol/static/media
chown -R appuser:appgroup /vol/static/media
